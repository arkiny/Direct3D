...
private:
	...
	void ParseVertexList	(OUT std::vector<D3DXVECTOR3>& vec);
	void ParseFaceList		(IN std::vector<D3DXVECTOR3>& vec, OUT std::vector<ST_PNT_VERTEX>& vecPNT);
	void ParseTVertList		(OUT std::vector<D3DXVECTOR2>& vec);
	void ParseTFaceList		(IN std::vector<D3DXVECTOR2>& vec, OUT std::vector<ST_PNT_VERTEX>& vecPNT);
